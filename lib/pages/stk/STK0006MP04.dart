...
class STK0006MP04 extends StatefulWidget {

  const STK0006MP04({Key key, this.param}) : super(key: key);
  final dynamic param;

  @override
  _STK0006MP04 createState() => _STK0006MP04();
}

class _STK0006MP04 extends State<STK0006MP04> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        appBar: pageAppBar(context, "Box패킹", false),
        body: FooterLayout(
