...
class INN0004MP01 extends StatefulWidget {
  const INN0004MP01({Key key, this.param}) : super(key: key);
  final dynamic param;

  @override
  _INN0004MP01 createState() => _INN0004MP01();
}

class _INN0004MP01 extends State<INN0004MP01> {
  ...
  Future<void> _search() async {
    ...
    await transaction(context, "INN0004/searchPack.do", param);
  ...
  Future<void> _insertPackId() async {
    ...
    if (resultList.isEmpty) {
      ...
      await transaction(context, "INN0004/insertBoxpack.do", resultList, (status, data) {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        appBar: pageAppBar(context, "workOrderSearch",false),
        body: FooterLayout(
            ...
            child: Container(
                ...
                child: GestureDetector(
                    ...
                    child: Column(children: <Widget>[
                      ...
                      Expanded(
                        child: CustomGrid(['lotNo', 'packAvailQty', 'packQty','workOrderNo',],
                         ['SHPR_ITEM_NM', 'BOX_AVAIL_QTY', 'EDIT_QTY','WORK_NO'],
                          _searchList,
