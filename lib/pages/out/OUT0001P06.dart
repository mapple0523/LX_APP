...
import 'package:dtwms_app/pages/out/OUT0001P07.dart';
...
class OUT0001P06 extends StatefulWidget {
  @override
  _OUT0001P06 createState() => _OUT0001P06();
}

class _OUT0001P06 extends State<OUT0001P06>  {
  ...
  Future<dynamic> savePage(BuildContext context, [dynamic param]) async {
    ...
    final result = await Navigator.push(context, MaterialPageRoute(fullscreenDialog: true, builder: (context) => OUT0001P07(param: param)));
