...
import 'package:dtwms_app/pages/out/OUT0009P01.dart';
...
class OUT0009M extends StatefulWidget {
  const OUT0009M({Key key, this.param}) : super(key: key);
  final dynamic param;

  @override
  _OUT0009M createState() => _OUT0009M();
}

class _OUT0009M extends State<OUT0009M> {
  ...
  Future<void> _searchStockList() async {
    ...
    Map<String, dynamic> param = {};
    param['SHPR_ITEM_CD'] = _materialNm.text;
    param['PLANT'] = _plantValue;
    param['SLOC'] = _slocVal;

    List<dynamic> rtnList =
        await transaction(context, "out/OUT0009/searchStockInfoList.do", param);
  ...
  Future<dynamic> callNavi(BuildContext context, [dynamic param]) async {
    ...
    param['confDt'] = _selPickDtFrom.text;
    // param['fromPlant'] = _plantValue;
    // param['fromSloc'] = _slocVal;

    final result = await Navigator.push(
        context,
        MaterialPageRoute(
            fullscreenDialog: true,
            builder: (context) => OUT0009P01(param: param)));
            ...
            children: <Widget>[
              ...
              CommonMaterial(
                ...
                onEditingComplete: (result, [selectedData]) {
                  ...
                  _materialNm.text = selectedData['ITEM_CD']?.toString() ?? '';
