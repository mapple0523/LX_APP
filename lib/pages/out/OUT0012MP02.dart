...
class OUT0012MP02 extends StatefulWidget {
  const OUT0012MP02({Key key, this.param}) : super(key: key);
  final dynamic param;

  @override
  _OUT0012MP02 createState() => _OUT0012MP02();
}

class _OUT0012MP02 extends State<OUT0012MP02> {
  ...
  Future<void> _search() async {
    ...
    _carryingQty.text = _searchList[0]['TOTAL_CAR_INPUT_QTY'].toString();
  ...
  Future<void> _handleCMScan(String scannedValue) async {
    ...
    if (woNoList.length > 1) {
      final result = await showSmallPopup(
        context, woNoList, ["SHPR_ITEM_CD", "LOCATION_CD", "STATUS"],
      );
  ...
  void initState() {
    ...
    print("************************* \nOUT0012MP02 paramater ${widget.param}");
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        appBar: pageAppBar(context, "상차출고(내수)", false),
        body: FooterLayout(
          footer: Container(
            child: Column(
