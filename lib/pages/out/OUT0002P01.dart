...
class OUT0002P01 extends StatefulWidget {
  @override
  _OUT0002P01 createState() => _OUT0002P01();
}

class _OUT0002P01 extends State<OUT0002P01> {
  final TextEditingController _selOutNoVal = TextEditingController();
  final TextEditingController _selCustNM = TextEditingController();
  ...
  Future<dynamic> callNavi(BuildContext context, [dynamic param]) async {
    if(CommonUtil.isNull(_selOutNoVal.text)){
      param['OUT_NO'] = "";
    }
    param['custList'] = _searchCustOutList;
    ...
    final result = await Navigator.push(
        ...
        MaterialPageRoute(
            ...
            builder: (context) => OUT0002P03(param: param)));
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        appBar: pageAppBar(context, "registerSerial"),
        body: Container(
